...
INPUT_METADATA_FILENAME = "floor_plan_metadata_v1.csv" # <<< Use the latest correct CSV

# Output Metadata CSV file (with counts filled in)
OUTPUT_METADATA_FILENAME = "floor_plan_metadata_v1_counts.csv" # <<< Save to a new file
