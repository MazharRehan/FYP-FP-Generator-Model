"""
📥 Read floor plan images
🎯 Parse filename & structure
🧮 Analyze room types, counts, and areas
📝 Generate JSON metadata for each image
📤 Save metadata organized by plot size (e.g., 5Marla/metadata/json/)
"""
import os
import json
import numpy as np
