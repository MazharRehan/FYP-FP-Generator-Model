...
"""
🎯 Primary Objectives
It improves upon previous versions by combining:
Analyze color-coded floor plan images (PNG)
Extract room-wise data (count, pixel area, square footage, instance-level stats)
Generate structured outputs:
✅ JSON (per file)
✅ CSV (all files summarized)
"""
import os
import json
import numpy as np
