...
class Config:
    # Data parameters
    DATA_DIR = "dataset/" # Assumes flat structure: dataset/5Marla_....png, dataset/10Marla_....png etc.
    METADATA_PATH = "floor_plan_metadata_consolidated_v6.csv" # Use the latest CSV name
